...
class _$AuthUserImpl implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(uid: $uid, email: $email, name: $name, role: $role, academyId: $academyId, photoUrl: $photoUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, email, name, role, academyId, photoUrl);
